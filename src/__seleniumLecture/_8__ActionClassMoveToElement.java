...
public class _8__ActionClassMoveToElement {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//storing the element into WebElement reference:
		WebElement electronics = driver.findElement(By.linkText("Electronics"));
		//creating an object of Action class by adding the WebDriver reference inside the argument:
		Actions action = new Actions(driver);
		//moving the mouse pointer over the element that is named: Electronics located on the ebay.com web-page.
		action.moveToElement(electronics).perform();
		//using hard wait method to pause the code execution for 6-six seconds:
		Thread.sleep(3000);
		//using close method to close the above launched browser single window:
		driver.close();
	}
